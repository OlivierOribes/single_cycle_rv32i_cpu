...
entity cpu is port
    (
        ...
        pc_next     : out std_ulogic_vector(DATA_WIDTH-1 downto 0);
...
architecture rtl of cpu is
    ...
    -- Data memory signals
    signal mem_write_data : std_ulogic_vector(DATA_WIDTH-1 downto 0) := (others => '0');    -- data to write in memory
...
begin
    ...
    pc_next     <= pc_out;      -- Address of the next instruction in the imem
