...
Once all instructions have been implemented and validated through simulations using ModelSim, the processor will be synthesized and tested on hardware using Vivado 2025.2 and a Basys 3 FPGA development board.
